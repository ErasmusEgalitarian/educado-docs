...
![Database](/docs/assets/2025/Software/deliverables/US-0021/database.png) 
...
- `LectureScreen.tsx` is unneeded. `lectureType` should determine the type of the lesson, and then that should call the `VideoLectureScreen.tsx`, not the `LectureScreen.tsx` which in turn calls the `VideoLectureScreen.tsx` component.
...
![Screenshot](/docs/assets/2025/Software/deliverables/US-0021/screenshot.png) 
