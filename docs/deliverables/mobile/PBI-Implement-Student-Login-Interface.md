...
- Minor visual changes was also made to the welcome screen in order to align more with the Figma design.
---
...
|------------|-----------|
| ![Login Before](../../assets/2025/Software/deliverables/US-0003/Login_Before.png) | ![Login after](../../assets/2025/Software/deliverables/US-0003/login_after.png) |


| Password Interface Before | Password Interface After |
|------------|-----------|
| ![Password Before](../../assets/2025/Software/deliverables/US-0003/Password_Combined_Before.png) | ![Password Before](../../assets/2025/Software/deliverables/US-0003/Password_Combined_Before.png) |
...
- ```components/General/Forms/PasswordEye.tsx```
